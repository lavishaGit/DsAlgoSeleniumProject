...
import org.testng.annotations.Test;
	  ...
	  public class TextEditor_Arraylist extends Arraylinks{
		  WebDriver driver;
		  
			public TextEditor_Arraylist(WebDriver driver) {
				//	PageFactory.initElements(driver, this);
				  this.driver=driver;
				  }
			
				  public void TextEditor_Arraylist() throws InterruptedException {
...
//TextEditor_Arraylist aaraylist  = PageFactory.initElements(driver, TextEditor_Arraylist.class);
		...
		aarlink.texttab.sendKeys("a = ['apple', 'banana', 'cherry']\nb = ['Ford', 'BMW', 'Volvo']\na.append(b)\nprint(a)");
			Thread.sleep(1000);
			aarlink.runbutton();
		...
		//********* Passing AlfaNumeric value in TextArea***********
			...
			aarlink.texttab.sendKeys("array list 123");
		Thread.sleep(1000);
		aarlink.runbutton();
